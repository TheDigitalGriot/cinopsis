@~/GriotMeta/agent-ontology/Codex/AGENTS.md

# Cinopsis

## Overview

YouTube video digest plugin for Codex. Browses subscribed channels, fetches transcripts, generates summary digests, and compares videos with an interactive dashboard.
...
`Codex -p`, and heartbeat each step to `.prism/local/<stage>-progress.txt`. Code-intel first:
